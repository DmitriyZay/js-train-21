...
class Guitarist extends Musician {
  ...
  // перевизначений метод play(), що виводить рядок
  //в консоль ${super.name} грає на ${super.instrument} в групі ${this.#band}
  joinBand() {
    this.#band = band;
    console.log(
...
// Тут ми використовуємо Object.defineProperty(), щоб додати сетер band
//до класу Musician після його створення.
// Перший аргумент - це об'єкт, до якого ми хочемо додати властивість.
//У цьому випадку це Musician.prototype,
...
// Третій аргумент - це об'єкт, який описує властивість.
//У цьому випадку ми хочемо додати сетер,
